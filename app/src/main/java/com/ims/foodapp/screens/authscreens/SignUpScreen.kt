...
@Composable
fun SignUpScreen(navController: NavController, fireViewModel: FireViewModel){
        ...
        Box (modifier = Modifier.fillMaxSize()){
            ...
            Column(modifier = Modifier.fillMaxSize()
                ...
                InputField(input = username, placeholder = "Enter your username", "Username", loading = fireViewModel.signLoading)
                ...
                Button(onClick = {
                    fireViewModel.signup(username.value,email.value,password.value)
                    username.value = ""
                    email.value = ""
                    password.value =""
                },
